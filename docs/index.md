...
Multi-Agent Communication & Task Routing — DAG workflows, message brokering, circuit breakers.

[![CI](https://github.com/invincible-jha/agent-mesh-router/actions/workflows/ci.yaml/badge.svg)](https://github.com/invincible-jha/agent-mesh-router/actions/workflows/ci.yaml)
...
[![License](https://img.shields.io/badge/license-Apache%202.0-blue.svg)](https://github.com/invincible-jha/agent-mesh-router/blob/main/LICENSE)
...
- [GitHub Repository](https://github.com/invincible-jha/agent-mesh-router)
- [PyPI Package](https://pypi.org/project/agent-mesh-router/)
- [Architecture](architecture.md)
- [Contributing](https://github.com/invincible-jha/agent-mesh-router/blob/main/CONTRIBUTING.md)
- [Changelog](https://github.com/invincible-jha/agent-mesh-router/blob/main/CHANGELOG.md)

---

## License

Apache 2.0 — see [LICENSE](https://github.com/invincible-jha/agent-mesh-router/blob/main/LICENSE) for full terms.
